          ...
          <div className="space-y-8">
            {favorites.map((product, i) => (
              ...
              >
                ...
                <div className="aspect-square rounded-lg bg-mediterranean-light border border-border flex items-center justify-center">
                ...
                <div className="md:col-span-2">
                  ...
                  <span className="font-body text-sm font-bold text-primary uppercase tracking-wider cursor-pointer hover:underline">
                    Learn More →
                  </span>
                </div>
              </div>
